...
const USER_ROLES = {
  admin: {
    ...
    tabs: ['dashboard','bookings','checkin','rooms','payments','reports','settings'],
    canCreate: true,
    canEdit: true,
    canDelete: true,
  ...
  accounting: {
    ...
    tabs: ['dashboard','bookings','payments','reports','settings'],
    canCreate: true,
    canEdit: true,
    canDelete: false,
    canManageSettings: false,
  ...
  housekeeping: {
    ...
    tabs: ['dashboard','checkin','rooms','settings'],
    canCreate: false,
    canEdit: true,
    canDelete: false,
    canManageSettings: false,
